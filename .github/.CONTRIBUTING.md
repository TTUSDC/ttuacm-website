...
- How do I set environment variables?
  ...
  - Run `yarn set-env name-of-service.foo=bar`
  - Example `yarn set-env auth.session_secret=SomeRandomSecret`
  - Run `yarn env-config` to be able to run the environment variables locally
