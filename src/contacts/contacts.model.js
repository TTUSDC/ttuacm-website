 ...
 */
Contacts.createContacts = () => new Promise(async (resolve, reject) => {
  try {
 ...
 */
Contacts.findOrCreateContactByEmail = async email => new Promise(async (resolve, reject) => {
  try {
    ...
    if (!userExistDb && userExistContacts) {
      ...
      const sdcGroupResourceNames = matchingUser[0].memberships.map((each, i) => each.contactGroupMembership.contactGroupId);
      const options = {
        email,
 ...
 */
Contacts.findOrCreateGroupByName = name => new Promise(async (resolve, reject) => {
 ...
 * @return {Promise<Object, Error>} - resolves with the complete Contact Group Object
 */
Contacts.addContactToGroup = (userResourceName, groupResourceName) => new Promise(async (resolve, reject) => {
  try {
    const options = {
 ...
 */
Contacts.deleteContactfromGroup = (userResourceName, groupResourceName) => new Promise(async (resolve, reject) => {
  try {
    const options = {
      resourceName: groupResourceName,
      requestBody: {
 ...
 */
Contacts.updateContactTopics = (email, groups) => new Promise(async (resolve, reject) => {
